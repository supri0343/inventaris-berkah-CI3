							...
							<div class="card-body">
								<form action="<?= base_url('toko/proses_ubah') ?>" id="form-tambah" method="POST">
									<div class="form-group">
										<label for="nama_toko"><strong>Nama Usaha : </strong></label>
										<input type="text" name="nama_toko" id="nama_toko" value="<?= $toko->nama_toko ?>" placeholder="Masukan Nama Usaha" class="form-control" readonly>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<button type="button" class="btn btn-warning" id="ubah"><i class="fa fa-pen"></i>&nbsp;&nbsp;Ubah</button>
