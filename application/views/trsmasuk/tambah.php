			...
			<div id="content" data-url="<?= base_url('trsmasuk') ?>">
				...
				<div class="clearfix">
					...
					<!-- <div class="float-right">
						<a href="<?= base_url('trsmasuk') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
					</div> -->
				</div>
				<!-- <hr> -->
				<div class="row">
					<div class="col">
						<div class="card shadow">
							<div class="card-header"><strong>Form Barang Masuk</strong>
								<div class="float-right">
									<a href="<?= base_url('trsmasuk') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
								</div>
							</div>
							<div class="card-body">
								<form action="<?= base_url('trsmasuk/proses_tambah') ?>" id="form-tambah" method="POST">
									<h5>Data Petugas</h5>
									<hr>
									<div class="form-row">
										<div class="form-group col-2">
											<label>No. Terima</label>
											<input type="text" name="no_terima" value="TRS<?= time() ?>" readonly class="form-control">
										</div>
