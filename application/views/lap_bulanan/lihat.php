...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content" data-url="<?= base_url('barang') ?>">
				...
				<div class="card shadow">
					<div class="card-header"><strong>Laporan Bulanan</strong>
					</div>
	...
	<script>
		...
		function redirect(){
			...
			location.href = "<?php echo base_url('lap_harian/export') ?>?laporan="+laporan+"&jenis="+jenis+"&bulan="+bulan+"&tahun="+tahun;
		}
