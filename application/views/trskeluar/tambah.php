			...
			<div id="content" data-url="<?= base_url('trskeluar') ?>">
				...
				<div class="clearfix">
					...
					<!-- <div class="float-right">
						<a href="<?= base_url('trskeluar') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
					</div> -->
				</div>
				<!-- <hr> -->
				<div class="row">
					<div class="col">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('trskeluar/proses_tambah') ?>" id="form-tambah" method="POST">
									<h5>Data Petugas</h5>
									<hr>
									<div class="form-row">
										<div class="form-group col-2">
											<label>No. Terima</label>
											<input type="text" name="no_keluar" value="TRS<?= time() ?>" readonly class="form-control">
										</div>
											...
											<div class="form-row">
												<!-- <div class="form-group col-10">
													...
													<select name="nama_customer" id="nama_customer" class="form-control">
														<option value="">Nama Customer (Manual)</option>
												...
												<div class="form-group col-12">
													...
													<input type="text" name="nama_customer" id="customer_name" value="" class="form-control" >
												</div>
											</div>
										</div>
										<div class="col-md-9">
											...
											<div class="form-row">
												...
												<div class="form-group col-3">
													...
													<input type="text" name="keteranganku" value="" class="form-control" >
												</div>
		...
		$(document).ready(function(){
			...
			$(document).on('click', '#tambah', function(e){
				...
				const data_keranjang = {
					...
					keterangan: $('input[name="keteranganku"]').val(),
				}
