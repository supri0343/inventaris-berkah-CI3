		...
		<div id="content-wrapper" class="d-flex flex-column">
			<div id="content" data-url="<?= base_url('supplier') ?>">
				...
				<div class="clearfix">
					...
					<!-- <div class="float-right">
						<?php if ($this->session->login['role'] == 'admin'): ?>
							<a href="<?= base_url('supplier/export') ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Cetak</a>
				...
				<div class="card shadow">
					<div class="card-header"><strong>Daftar Supplier</strong>
						<div class="float-right">
							<?php if ($this->session->login['role'] == 'admin'): ?>
								<a href="<?= base_url('supplier/export') ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Cetak</a>
								<a href="<?= base_url('supplier/tambah') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a>
							...
							<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
								...
								<?php foreach ($all_supplier as $supplier): ?>
									<tr>
										...
										<?php if ($this->session->login['role'] == 'admin'): ?>
										<td>
											<a href="<?= base_url('supplier/ubah/' . $supplier->kode) ?>" class="btn btn-warning btn-sm"><i class="fa fa-pen"></i></a>
