			...
			<div id="content" data-url="<?= base_url('pengguna') ?>">
				...
				<div class="card shadow">
					...
					<div class="float-left">
						<h1 class="h3 m-0 text-gray-800">Data Pengguna</h1>
					</div>
					<div class="float-right">
						<a href="<?= base_url('pengguna/export') ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Cetak</a>
								...
								<tbody>
									<?php foreach ($all_pengguna as $pengguna): ?>
										<tr>
											...
											<td>
												<a href="<?= base_url('pengguna/ubah/' . $pengguna->id) ?>" class="btn btn-warning btn-sm"><i class="fa fa-pen"></i></a>
