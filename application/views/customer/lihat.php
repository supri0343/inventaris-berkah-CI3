				...
				<div class="clearfix">
					...
					<div class="float-right">
						<?php if ($this->session->login['role'] == 'admin'): ?>
							<a href="<?= base_url('customer/export') ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Cetak</a>
							...
							<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
								...
								<?php foreach ($all_customer as $customer): ?>
									<tr>
										...
										<?php if ($this->session->login['role'] == 'admin'): ?>
										<td>
											<a href="<?= base_url('customer/ubah/' . $customer->kode) ?>" class="btn btn-warning btn-sm"><i class="fa fa-pen"></i></a>
