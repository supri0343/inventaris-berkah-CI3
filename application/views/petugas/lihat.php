				...
				<div class="card shadow">
					...
					<div class="float-right">
						<?php if ($this->session->login['role'] == 'admin'): ?>
							<a href="<?= base_url('petugas/export') ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Cetak</a>
									...
									<?php foreach ($all_petugas as $petugas): ?>
										<tr>
											...
											<?php if($this->session->login['role'] == 'admin'): ?>
												...
												<td>
													<a href="<?= base_url('petugas/ubah/' . $petugas->id) ?>" class="btn btn-warning btn-sm"><i class="fa fa-pen"></i></a>
